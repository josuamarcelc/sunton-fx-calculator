...
<html ⚡="">
  <head>
    ...
    <meta property="og:site_name" content="Sunton FX Calculator">
    ...
    <title>Sunton FX Calculator</title>
  ...
  <body>
      ...
      >
        ...
        <li>
          <a
            ...
            >
              <title>email</title>
              <path d="M10.5 6.4C9.1 6.4 8 7.5 8 8.9v21.3c0 1.3 1.1 2.5 2.5 2.5h34.9c1.4 0 2.5-1.2 2.5-2.5V8.9c0-1.4-1.1-2.5-2.5-2.5H10.5zm2.1 2.5h30.7L27.9 22.3 12.6 8.9zm-2.1 1.4l16.6 14.6c.5.4 1.2.4 1.7 0l16.6-14.6v19.9H10.5V10.3z"
    ...
    <div class="center">
      ...
      <div>
            <br/>
            <input type = "text" class="text-input-josuamarcelc" name = "name" placeholder = "Enter Investment Value" autocomplete="off"><br/><br/>
            <input type = "email" name = "email" 
            placeholder = "Enter Email" required>
            <br/>
         </div>
        <amp-img
          width="404" height="720" alt="Est epicuri indoctum ad, oblique conceptam ut vel consequuntur" layout="responsive" src="img/night.jpg" media="(max-width: 415px)"></amp-img>
        <amp-img height="720" alt="Est epicuri indoctum ad, oblique conceptam ut vel consequuntur" layout="fixed-height" src="img/night.jpg" media="(min-width: 416px)"></amp-img>
    ...
    <main id="content" role="main">
      <article class="photo-article">
        ...
        <figure class="ampstart-image-with-caption m0 relative mb4">
          <amp-img src="img/jump.jpg" width="756" height="520" alt="Description of the photograph." layout="responsive" class=""></amp-img>
          <figcaption class="h5 mt1 px3">
            Description of the photograph.
            <span class="ampstart-image-credit block bold">Taken by<a href="#" role="author">Andrew Branch</a></span>
          </figcaption>
        </figure>
        ...
        <amp-carousel width="756" height="638" layout="responsive" type="slides" class="mb4">
          <!-- Start Image with Caption -->
          <figure class="ampstart-image-with-caption m0 relative mb4">
            <amp-img src="img/cars.jpg" width="756" height="520" alt="New York cars." layout="responsive" class="" ></amp-img>
            <figcaption class="h5 mt1 px3">
              New York cars.
              <span class="ampstart-image-credit block bold">Taken by<a href="#" role="author">Jack Alexander</a></span>
            </figcaption>
          </figure>
          <!-- End Image with Caption -->
          ...
          <!-- Start Image with Caption -->
          <figure class="ampstart-image-with-caption m0 relative mb4">
            <amp-img src="img/street.jpg" width="756" height="520" alt="New York street" layout="responsive" class=""></amp-img>
            <figcaption class="h5 mt1 px3">
              New York street
              <span class="ampstart-image-credit block bold">Taken by<a href="#" role="author">Jack Alexander</a></span>
            </figcaption>
    ...
    <footer class="ampstart-footer flex flex-column items-center px3">
      <ul class="ampstart-social-follow list-reset flex justify-around items-center flex-wrap m0 mb4">
        <li>
          <a href="https://twitter.com/josuamarcelc" target="_blank" class="inline-block p1" aria-label="Link to Josuamarcelc Twitter">
        ...
        <li>
          <a href="https://www.facebook.com/JMCorp/" target="_blank" class="inline-block p1" aria-label="Link to Josuamarcelc Facebook">
        ...
        <li>
          <a href="https://id.pinterest.com/josuamarcel/" target="_blank" class="inline-block p1" aria-label="Link to Josuamarcelc pinterest">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="28.5" viewBox="0 0 43 51" >
              <title>pinterest</title>
              <path d="M8.134 18.748c0-1.6.2-3 .8-4.4.5-1.4 1.2-2.6 2.2-3.6.9-1 2-1.9 3.2-2.6 1.2-.8 2.5-1.3 3.9-1.7 1.5-.4 2.9-.5 4.4-.5 2.2 0 4.3.4 6.2 1.4 1.9.9 3.5 2.3 4.7 4.1 1.2 1.9 1.8 3.9 1.8 6.2 0 1.4-.1 2.7-.4 4-.2 1.3-.7 2.6-1.2 3.8-.6 1.2-1.3 2.3-2.2 3.2-.8.9-1.8 1.7-3.1 2.2-1.2.6-2.5.9-4 .9-1 0-1.9-.3-2.9-.7-.9-.5-1.6-1.1-2-1.9-.1.5-.3 1.4-.6 2.4-.3 1.1-.4 1.7-.5 2-.1.3-.2.9-.4 1.6-.3.7-.4 1.2-.6 1.5-.1.3-.4.7-.7 1.3-.3.6-.6 1.2-1 1.7-.3.5-.7 1.1-1.3 1.8l-.3.1-.2-.2c-.2-2.2-.3-3.6-.3-4 0-1.3.2-2.8.5-4.4.3-1.7.8-3.7 1.4-6.2.6-2.5 1-3.9 1.1-4.4-.5-.9-.7-2.1-.7-3.6 0-1.2.4-2.3 1.1-3.3.8-1.1 1.7-1.6 2.8-1.6.9 0 1.6.3 2.1.9.4.6.7 1.3.7 2.2 0 .9-.3 2.3-1 4.1-.6 1.8-.9 3.1-.9 4 0 .9.3 1.6 1 2.2.6.6 1.4.9 2.3.9.8 0 1.5-.2 2.2-.5.6-.4 1.2-.9 1.6-1.5.5-.6.9-1.3 1.2-2 .4-.8.6-1.5.8-2.4.2-.8.4-1.6.5-2.4.1-.7.1-1.4.1-2.1 0-2.5-.8-4.4-2.3-5.8-1.6-1.4-3.6-2.1-6.1-2.1-2.8 0-5.2 1-7.1 2.8-1.9 1.9-2.9 4.2-2.9 7.1 0 .6.1 1.2.3 1.8.2.6.4 1.1.6 1.4.2.3.4.7.5 1 .2.3.3.5.3.6 0 .4-.1.9-.3 1.6-.2.6-.5 1-.8 1 0 0-.1-.1-.4-.1-.7-.2-1.3-.6-1.9-1.2-.5-.6-1-1.3-1.3-2-.3-.8-.5-1.6-.7-2.4-.2-.7-.2-1.5-.2-2.2z" class="ampstart-icon ampstart-icon-pinterest" ></path></svg
          ></a>
        </li>
        <li>
          <a href="mailto:josuamarcelc.com@gmail.com" target="_blank" class="inline-block p1" aria-label="Link to Josuamarcelc E-mail">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="18.4" viewBox="0 0 56 43" >
              <title>email</title>
              <path d="M10.5 6.4C9.1 6.4 8 7.5 8 8.9v21.3c0 1.3 1.1 2.5 2.5 2.5h34.9c1.4 0 2.5-1.2 2.5-2.5V8.9c0-1.4-1.1-2.5-2.5-2.5H10.5zm2.1 2.5h30.7L27.9 22.3 12.6 8.9zm-2.1 1.4l16.6 14.6c.5.4 1.2.4 1.7 0l16.6-14.6v19.9H10.5V10.3z"
                class="ampstart-icon ampstart-icon-email"></path></svg></a>
        </li>
      </ul>
      <nav class="ampstart-footer-nav">
        <ul class="list-reset flex flex-wrap mb3">
          <li class="px1">
            <a class="text-decoration-none ampstart-label" href="https://josuamarcelc.com/about-me/" target="_blank" aria-label="Link to Josuamarcelc About Him">About</a>
          </li>
          <li class="px1">
            <a class="text-decoration-none ampstart-label" href="https://josuamarcelc.com/contact/" target="_blank" aria-label="Link to Josuamarcelc Contact">Contact</a>
          </li>
        </ul>
      </nav>
