...
<html ⚡="">
  <head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-37279528-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-37279528-1');
    </script>
          ...
          <li class="ampstart-nav-item ampstart-nav-dropdown relative">
            <amp-accordion layout="container" disable-session-states="" class="ampstart-dropdown">
              <section>
                ...
                <ul class="ampstart-dropdown-items list-reset m0 p0">
                  <li class="ampstart-dropdown-item">
                    <a href="https://play.google.com/store/apps/developer?id=siakew" class="text-decoration-none">Android Apps</a>
                  </li>
                  <li class="ampstart-dropdown-item">
                    <a href="https://www.youtube.com/siakew" class="text-decoration-none">Youtube</a>
                  </li>
                  <li class="ampstart-dropdown-item">
                    <a href="https://saweria.co/josuamarcelc" class="text-decoration-none">Donate</a>
                  </li>
                </ul>
              </section>
            </amp-accordion>
        ...
        <div>
          ...
          <amp-lightbox id="my-bindable-lightbox" [open]="showLightbox" layout="nodisplay" on="lightboxClose:AMP.setState({showLightbox: false})">
            <div class="lightbox" role="button" tabindex="0" on="tap:my-bindable-lightbox.close">
              <div class="table-responsive" style="font-family: 'Azeret Mono', monospace;">
                <table>
                  <thead>
                    <tr>
                      <td align="left">UKOIL</td>
          ...
          <button on="tap:AMP.setState({showLightbox: true})" class="bubbly-button" style="padding:7px !important;background-color:#00DCDC !important;border-radius:30px;">
  ...
  <script>
    ...
    function resetInputSubmit(){
      ...
      localStorage.setItem("modal_value", "");
      document.getElementById("label-result").innerHTML = 
    ...
    window.onload = function() {
        ...
        if(localStorage.getItem("stock_value") == "option_1") {
          document.getElementsByName("select-stock")[0].checked = true;
        }else if(localStorage.getItem("stock_value") == "option_2"){
          document.getElementsByName("select-stock")[1].checked = true;
        }else{
          document.getElementsByName("select-stock")[0].checked = true;
        }
        document.getElementById("input-submit").value = localStorage.getItem("modal_value");
        inputAssetChange();
    }
  </script>
